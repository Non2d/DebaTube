...
export const ja: LocaleType = {
    ...
    recordPage: {
        ...
        messages: {
            ...
            confirmGenerateTitle: "グラフを生成しますか？",
            confirmGenerateDescription: "これには数分かかる場合があります。",
            confirmGenerateCancel: "キャンセル",
            confirmGenerateConfirm: "生成する",
    ...
    dashboard: {
        ...
        steps: {
            ...
            messages: {
                ...
                noVideoId: "エラー: 動画IDが見つかりません",
                downloadingAudio: "ステップ1-A: 音声をダウンロード中...",
                audioDownloadFailed: "音声のダウンロードに失敗しました",
                downloadedAudio: "ステップ1-A: ダウンロード完了 (${video_id})",
                audioDownloadCompleted: "ステップ1-A: 音声ダウンロード完了",
                backgroundAudioDownloadRegistered: "ステップ1-A: バックグラウンドで音声のダウンロードを登録しました。完了をお待ちください。",
                step1aCompleted: "ステップ1-A 完了（音声ダウンロード済み）",
                step1bCompleted: "ステップ1-B 完了（文字起こし済み）",
                step1cCompleted: "ステップ1-C 完了（単語抽出済み）",
                step1dCompleted: "ステップ1-D 完了（文グループ化済み）",
                ...
                retrievingResult: "ステップ1-B: 結果を取得中...",
                failedGetTranscriptionResult: "文字起こし結果の取得に失敗しました",
                transcriptionCompleted: "ステップ1-B: 完了",
                transcribing: "ステップ1-B: 文字起こし中...",
                transcriptionFailed: "文字起こしに失敗しました",
                extractingWords: "ステップ1-C: 単語を抽出中...",
                wordExtractionFailed: "単語の抽出に失敗しました",
                wordExtractionCompleted: "ステップ1-C: 完了",
                groupingSentences: "ステップ1-D: 文をグループ化中...",
                sentenceGroupingFailed: "文の生成に失敗しました",
                sentenceGroupingCompleted: "ステップ1-D: ${count} 文",
                step1Complete: "ステップ1 完了！",
                resultSavedToDb: "ステップ1-B: 結果をDBに保存しました",
                diarizationComplete: "話者識別完了！",
                autoAduGenerationFailed: "自動ADU生成に失敗しました",
                aduGenerationComplete: "ADU生成完了！",
                autoRebuttalGenerationFailed: "自動反論判定に失敗しました",
                rebuttalGenerationComplete: "反論判定完了！",
                allStepsCompleted: "全ステップ完了！",
            }
        },
    }
};
