    ...
    dashboard: {
        ...
        steps: {
            ...
            messages: {
                ...
                audioDownloadCompleted: "Step 1-A: Audio download completed",
                backgroundAudioDownloadRegistered: "Step 1-A: Background audio download registered. Waiting for completion...",
                step1aCompleted: "Step 1-A completed (Audio downloaded)",
                step1bCompleted: "Step 1-B completed (Transcription done)",
                step1cCompleted: "Step 1-C completed (Words extracted)",
                step1dCompleted: "Step 1-D completed (Sentences grouped)",
