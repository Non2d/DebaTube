...
export default function RecordDashboard() {
    ...
    // removed isModalOpen since button is removed
            ...
            <div className="min-h-screen bg-background text-foreground pt-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="mb-8 flex justify-between items-start">
                        ...
                        {/* Register New Round Button Removed as requested */}
                    </div>
                                                    ...
                                                    return (
                                                        <tr
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                router.push(`/${language}/record?tab=visualization&roundName=${encodeURIComponent(round.title)}&tryCount=${round.try_count || 1}`);
                                                            }}
                                                        >
