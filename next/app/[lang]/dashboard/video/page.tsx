                                        ...
                                        {loading ? (
                                            ...
                                            (() => {
                                                ...
                                                return filteredRounds.map((round, index) => {
                                                    ...
                                                    if (isGrouped) {
                                                        if (isSameTitleAsNext) rowClass = "border-b-0 border-gray-100 dark:border-gray-800"; // Lighter separator
                                                        else rowClass = "border-b border-gray-200 dark:border-gray-700"; // End of group
                                                    }
                                                    // Removed hover effect and cursor-pointer as it's not clickable for navigation
